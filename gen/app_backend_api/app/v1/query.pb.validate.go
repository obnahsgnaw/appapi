...
// Validate checks the field values on UcuAppRequest with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *UcuAppRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UcuAppRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UcuAppRequestMultiError, or
// nil if none found.
func (m *UcuAppRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UcuAppRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UcuAppRequestMultiError(errors)
	}

	return nil
}

// UcuAppRequestMultiError is an error wrapping multiple validation errors
// returned by UcuAppRequest.ValidateAll() if the designated constraints
// aren't met.
type UcuAppRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UcuAppRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UcuAppRequestMultiError) AllErrors() []error { return m }

// UcuAppRequestValidationError is the validation error returned by
// UcuAppRequest.Validate if the designated constraints aren't met.
type UcuAppRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UcuAppRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UcuAppRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UcuAppRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UcuAppRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UcuAppRequestValidationError) ErrorName() string { return "UcuAppRequestValidationError" }

// Error satisfies the builtin error interface
func (e UcuAppRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UcuAppRequestValidationError{}
